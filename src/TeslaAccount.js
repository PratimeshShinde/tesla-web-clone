    ...
    return (
        <div className="teslaAccount">
            ...
            <div className="teslaAccount__car">
                <Car
                  imgSrc='https://www.tesla.com/tesla_theme/assets/img/mytesla/v3/header-nocar-models@2x.jpg' model='model s' testDrive/>
                <Car 
                  imgSrc='https://www.tesla.com/tesla_theme/assets/img/mytesla/v3/header-nocar-modelx@2x.jpg' model='model x' />
            </div>
        </div>
    )
}
